...
const api: ConnectApi = {
  ...
  createProfile: (input) => ipcRenderer.invoke('connect:create-profile', input),
  activateProfile: (profileId) => ipcRenderer.invoke('connect:activate-profile', profileId),
  deleteProfile: (profileId) => ipcRenderer.invoke('connect:delete-profile', profileId),
