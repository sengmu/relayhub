<template>
  <div
    class="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-50 via-white to-slate-100 p-4"
  >
    <div class="w-full max-w-2xl">
      ...
      <div class="mb-8 text-center">
        ...
        <h1 class="text-3xl font-bold text-gray-900 text-slate-950">{{ t('setup.title') }}</h1>
        <p class="mt-2 text-slate-500">{{ t('setup.description') }}</p>
      </div>
      ...
      <div class="rounded-2xl bg-white p-8 shadow-xl">
        ...
        <div v-if="currentStep === 0" class="space-y-6">
          <div class="mb-6 text-center">
            <h2 class="text-xl font-semibold text-gray-900 text-slate-950">
          ...
          <div class="flex items-center justify-between rounded-xl border border-slate-200 p-3">
            <div>
              <p class="text-sm font-medium text-gray-900 text-slate-950">
        ...
        <div v-if="currentStep === 3" class="space-y-6">
          ...
          <div class="space-y-4">
            <div class="rounded-xl bg-slate-50 p-4">
              ...
              <p class="text-gray-900 text-slate-950">
            ...
            <div class="rounded-xl bg-slate-50 p-4">
              ...
              <p class="text-gray-900 text-slate-950">{{ formData.admin.email }}</p>
            </div>
          </div>
        </div>
